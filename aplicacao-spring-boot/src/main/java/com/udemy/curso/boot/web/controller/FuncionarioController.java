package com.udemy.curso.boot.web.controller;
...
import com.udemy.curso.boot.domain.UF;
import com.udemy.curso.boot.service.CargoService;
import com.udemy.curso.boot.service.FuncionarioService;
import com.udemy.curso.boot.web.validator.FuncionarioValidator;
...
public class FuncionarioController {
	...
	public String excluir(@PathVariable("id") Long id, RedirectAttributes attr) {
		...
		attr.addFlashAttribute("fail", "Funcionario removido com sucesso.");
